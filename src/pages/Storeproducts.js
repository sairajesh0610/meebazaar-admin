...
import Storeprodsizes from './Storeprodsizes';
...
class Storeproducts extends React.Component {
    ...
    componentDidMount(){
        ...
        getObjData({objtype:this.state.objtype},this.setData,this.growl,'storeprdlist');
        this.getCatList();
    ...
    getCatList = () => {
        callsvc({table:'mb_store_pdl'},'catlistall',false)
        .then((res)=>{
            if(res.code == '999'){
                        ...
                        if(it.type == 'text'){
                            ...
                            return (
                                <div className="p-col-12 p-md-6 p-lg-4" key={it.seq}>
                                        ...
                                        <Dropdown id={it.field}  value={it.val} style = {{minWidth:'233px'}} options={it.field == 'catname' ? this.state.catlist:""} 
