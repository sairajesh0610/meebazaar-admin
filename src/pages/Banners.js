...
class Banners extends React.Component {
    ...
    getList = () => {
        ...
        .then((res)=>{
            if(res.code == '999'){
                ...
                let slideTypeArr = []
                for(let i=0; i<res.data.length;i++){
                    if(res.data[i].atype=="SLIDE_LOC_FLDS"){
            ...
            console.log("slideloc",slideLocArr);
            console.log("slidetype",slideTypeArr);
    ...
    saveRow = ()=>{
        ...
        a.slideloc = (a.slideloc && a.slideloc.val) ? a.slideloc.val:'';
        console.log("a",a);
