...
class Locationstores extends React.Component{
    ...
    componentDidMount(){
        ...
        getObjData({locid:this.props.locid},this.setData,this.growl,'getlocstores')
    }
   ...
   customBody(rowData,column){
    ...
    saveRow = ()=>{
        ...
        console.log('a',a)
        saveDataRow(a,this.state.data,this.setData,this.growl,this.state.idfld,'activatelocstore');
    }
            ...
            <div style={{position:'relative'}}> 
             {this.state.showSpinner && <AppSpinner spinColor="dark" showText={false} scrHeight={window.screen.height-210}/>}
                <Growl ref={(el) => this.growl = el} sticky={true}/>
                    ...
                    <TableData 
                        screenopt        =  {Object.assign({},this.props.scrOptions,{name:`Strores for ${this.props.parname}`})} 
