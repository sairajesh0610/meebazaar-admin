...
class Prodsizes extends React.Component {
    ...
    componentDidMount(){
        ...
        getObjData({objtype:this.state.objtype},this.setData,this.growl,'getprditdata');
    ...
    render () {
        ...
        <div className="p-toolbar-group-right">
            ...
            <Button icon="pi pi-plus"  style={{marginRight:'.25em'}}  tooltip="New Record" tooltipOptions={{position: 'top'}} onClick={()=>{ this.showEditModal('ADD')}} disabled={!this.state.scrOptions.addopt}/>
            <Button  icon="pi pi-pencil" className="p-button-warning" style={{marginRight:'.25em'}} tooltip="Update Record" tooltipOptions={{position: 'top'}} onClick={()=>{ this.showEditModal('EDIT')}} disabled={!this.state.scrOptions.editopt}/> 
            <Button  icon="pi pi-trash" className="p-button-danger" onClick={()=>{this.setState({deleteDialog:true})}} tooltip="Delete Record" tooltipOptions={{position: 'top'}} disabled={!this.state.scrOptions.delopt}/>
        </div>
