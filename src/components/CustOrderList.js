...
class CustOrderList extends React.Component {
    ...
    componentDidMount(){
        ...
        getObjData({objtype:this.state.objtype,custid:this.props.parid,type:this.props.type},this.setData,this.growl,'custorderdata');
        this.getdbList();
    }
    ...
    render () {
            const renderCancel = ['SUBMITTED','ORDER_READY'].includes(this.state.selectedRow.ordstatus);
            ...
            return (
                ...
                <DataTable
                 ...
                 >
                    ...
                    {(this.state.editDialog && this.state.selectedRow && this.state.selectedRow.ordid) && <OrderdetailDialog ordobj={this.state.selectedRow} setData = {this.setData} editDialog={this.state.editDialog}/>}
