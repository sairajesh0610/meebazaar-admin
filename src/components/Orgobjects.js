...
class Orgobjects extends React.Component {
    ...
    componentDidMount(){
        ...
        if(this.props.parid)
        getObjData({objtype:this.state.objtype,selorgid:this.props.parid},this.setData,this.growl)
        else
