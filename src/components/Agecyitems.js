...
class Agencyitems extends React.Component {

    constructor(props){
        super(props);
        this.state = {
            objtype:'AGENCY_ITEM_FLDS',
            ...
            scrOptions:{name:'Product Items',icon:'',editopt:false,addopt:false,expopt:false,delopt:false}
        }
    }
    ...
    componentDidMount(){
        ...
        getObjData({objtype:this.state.objtype,transid:this.props.transid,agencyid:this.props.agencyid},this.setData,this.growl);
        
    }

    componentDidUpdate(prevProps){
        if(this.props.transid != prevProps.transid){
