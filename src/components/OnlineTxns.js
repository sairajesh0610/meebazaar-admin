...
class OnlineTxns extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            selectedTranType:'CREDIT',updateDialog:false,agencyProds:[],
    ...
    componentDidMount(){
        ...
        getObjData({objtype:this.state.objtype,orgid:this.state.userobj.orgid,method:'ONLINE'},this.setData,this.growl);
        ...
        const header = (
            ...
            <div style={{position:'relative'}}> 
             {this.state.showSpinner && <AppSpinner spinColor="dark" showText={false} scrHeight={window.screen.height-210}/>}
                ...
                <div>
                <div  style={{marginLeft:'45%',marginTop:'0.5em',width:'70px',backgroundColor:'red',borderRadius:'2px',textAlign:'center',fontSize:'100%',color:'white',top:0}}>ONLINE</div>
                <div>
