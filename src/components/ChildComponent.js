...
class ChildComponent extends React.Component {
    ...
    componentDidMount(){
        ...
        this.setState({objtype:objtype});
        
        getObjFlds({objtype:objtype},this.setData,this.growl,this.customBody)
        if(this.props.parid)
        getObjData({objtype:objtype,parid:this.props.parid},this.setData,this.growl)
        else
